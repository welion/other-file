...
echo ---------------------------server passwd: $ss_basic_password ---------------------
echo ---------------------------server port: $ss_basic_port ---------------------------
echo ---------------------------server method: $ss_basic_method -----------------------
#export server_ip="103.207.70.48"
#export ss_basic_password="Li0nss1234"
#export ss_basic_port=8899
#export ss_basic_method="aes-256-cfb"

export server_ip=$1
export ss_basic_server=$1
export ss_basic_password=$2
export ss_basic_port=$3
export ss_basic_method=$4
